...
const uint8_t enemy_spawn_list[][6]={
    ...
    {ENEMY_TYPE_MINI_BOSS_1, ENEMY_HP_10, BULLET_TYPE_LARGE, MOVE_PATTERN_DOWN, SHOOT_PATTERN_AIMED, SHOT_SPEED_MEDIUM}
...
const uint8_t level_demo_events[][5] = {
    ...
    {60, EVENT_SPAWN_ENEMY, ENEMY_MINI_BOSS_1_DOWN_SHOOT_AIMED, 80, 8},
    {240, EVENT_NONE,        0, 0, 0},
