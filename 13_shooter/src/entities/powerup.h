...
#define POWERUP_GAMESCREEN_X_ORIGIN  (GAMESCREEN_X_ORIGIN-4u)
#define POWERUP_GAMESCREEN_Y_ORIGIN  (GAMESCREEN_Y_ORIGIN-8u)
#define POWERUP_GAMESCREEN_X_END     (GAMESCREEN_X_END+4u)
#define POWERUP_GAMESCREEN_Y_END     (GAMESCREEN_Y_END+8u)
