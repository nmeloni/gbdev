...
const LevelEvent level_1_events[]={
  ...
  {.level_event_type = LEVEL_EVENT_SPAWN_ENEMY, .enemy_type = ENEMY_SWARMER, .enemy_data_type = ENEMY_DATA_DRONE_1, .x = 80, .y = 8, .duration = 240},
  {.level_event_type = LEVEL_EVENT_SPAWN_ENEMY, .enemy_type = ENEMY_DRONE, .enemy_data_type = ENEMY_DATA_DRONE_1, .x = 80, .y = 8, .duration = 240},
    {.level_event_type = LEVEL_EVENT_SPAWN_ENEMY, .enemy_type = ENEMY_PROBE, .enemy_data_type = ENEMY_DATA_SCOUT_2, .x = 4, .y = 60, .duration = 240},
    {.level_event_type = LEVEL_EVENT_POWERUP_SHIELD, .enemy_type = ENEMY_NONE, .enemy_data_type = ENEMY_DATA_NONE, .x = 0, .y = 0, .duration = 0},
    {.level_event_type = LEVEL_EVENT_SPAWN_ENEMY, .enemy_type = ENEMY_SCOUT, .enemy_data_type = ENEMY_DATA_SCOUT_1, .x = 168, .y = 60, .duration = 240},
    ...
    {.level_event_type = LEVEL_EVENT_SPAWN_ENEMY, .enemy_type = ENEMY_SPHERE, .enemy_data_type = ENEMY_DATA_DRONE_1, .x = 80, .y = 8, .duration = 240},
     ...
     {.level_event_type = LEVEL_EVENT_NONE,              .enemy_type = ENEMY_NONE, .enemy_data_type = ENEMY_DATA_NONE, .x = 0, .y = 0, .duration = 240},
    {.level_event_type = LEVEL_EVENT_BOSS_BEHOLDER,              .enemy_type = ENEMY_NONE, .enemy_data_type = ENEMY_DATA_NONE, .x = 0, .y = 0, .duration = 0},
    {.level_event_type = LEVEL_EVENT_NONE,              .enemy_type = ENEMY_NONE, .enemy_data_type = ENEMY_DATA_NONE, .x = 0, .y = 0, .duration = 240},
